...
VALUES
('S-001','Nguyen Thanh Son','Head Manager',NULL,'0901000001 | head.manager@fleetops.com','head.manager','$2b$12$zaoWEliUX61UisITW6e2jOIQLR1MoU7Qip30836ufCMx8y4Wl94WW'),
('S-002','Tran Minh Khoa','Depot Manager',1,'0901000002 | depot.manager.hn@fleetops.com','depot.manager.hn','$2b$12$zaoWEliUX61UisITW6e2jOIQLR1MoU7Qip30836ufCMx8y4Wl94WW'),
('S-003','Le Thu Ha','Depot Manager',2,'0901000003 | depot.manager.dn@fleetops.com','depot.manager.dn','$2b$12$zaoWEliUX61UisITW6e2jOIQLR1MoU7Qip30836ufCMx8y4Wl94WW'),
('S-004','Pham Quang Huy','Depot Manager',3,'0901000004 | depot.manager.hcm@fleetops.com','depot.manager.hcm','$2b$12$zaoWEliUX61UisITW6e2jOIQLR1MoU7Qip30836ufCMx8y4Wl94WW'),
('S-005','Vu Ngoc Anh','Depot Manager',4,'0901000005 | depot.manager.ct@fleetops.com','depot.manager.ct','$2b$12$zaoWEliUX61UisITW6e2jOIQLR1MoU7Qip30836ufCMx8y4Wl94WW'),
('S-006','Hoang Gia Bao','Workshop Manager',1,'0901000006 | workshop.manager.hn@fleetops.com','workshop.manager.hn','$2b$12$zaoWEliUX61UisITW6e2jOIQLR1MoU7Qip30836ufCMx8y4Wl94WW'),
('S-007','Doan Minh Tuan','Driver Manager',2,'0901000007 | driver.manager.dn@fleetops.com','driver.manager.dn','$2b$12$zaoWEliUX61UisITW6e2jOIQLR1MoU7Qip30836ufCMx8y4Wl94WW'),
('S-008','Nguyen Thuy Linh','Inventory Manager',NULL,'0901000008 | inventory.manager@fleetops.com','inventory.manager','$2b$12$zaoWEliUX61UisITW6e2jOIQLR1MoU7Qip30836ufCMx8y4Wl94WW'),
('S-009','System Administrator','Head Manager',NULL,'0901000009 | admin@fleetops.com','admin','$2b$12$zaoWEliUX61UisITW6e2jOIQLR1MoU7Qip30836ufCMx8y4Wl94WW');

-- File: 05_supplier_data.sql
...
-- File: 07_part_supplier_data.sql
...
-- File: 10_mechanic_cert_history_data.sql
...
-- File: 11_predictive_alert_data.sql
...
('VIN00000000000005', 4, 'Oil Quality Deterioration', 'Acknowledged');


-- File: 12_safety_event_data.sql
...
-- File: 13_driver_certification_data.sql
...
-- File: 14_driver_safety_score_data.sql
...
-- File: 15_vehicle_driver_assignment_data.sql
...
-- File: 16_maintenance_job_data.sql
...
VALUES
('VIN00000000000001', 1, 1, '2026-02-01', '2026-02-03', 8.50, 1500000.00),
('VIN00000000000002', 1, 2, '2026-03-05', NULL, NULL, NULL),
('VIN00000000000003', 2, 3, '2026-01-20', '2026-01-25', 40.00, 8500000.00),
('VIN00000000000004', 3, 4, '2025-12-10', '2025-12-15', 30.00, 6200000.00),
('VIN00000000000005', 4, NULL, '2026-04-01', '2026-04-02', 5.00, 500000.00);


-- File: 17_maintenance_activity_data.sql
...
-- File: 18_activity_part_data.sql
...
-- File: 19_activity_mechanic_assignment_data.sql
...
-- File: 20_warranty_claims_data.sql
...
-- File: 21_Event_penalty_data.sql
